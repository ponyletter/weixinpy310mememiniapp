...
SCENE_TEXT_PACKAGES = {
    ...
    "daily": [
        "OK没问题", "比心心", "冲鸭", "干饭干饭",
        "自闭了", "抱头痛哭", "气死我了", "吓我一跳",
        "无所谓", "你认真的吗", "暗中自嗨", "不好意思啦",
        "求求了", "坐等好戏", "好困啊", "撤退撤退"
    ],
    "couple": [
        "想你啦", "亲亲一个", "在忙什么呀", "给你送爱心",
        "哼不理你了", "委屈哭唧唧", "气鼓鼓", "哇你好帅/美",
        "叹气想抱抱", "又在想谁呢", "今天超酷", "脸红害羞",
        "求抱抱嘛", "监督你干饭", "想和你贴贴", "飞奔奔向你"
    ],
    "memes": [
        "泰裤辣", "泰棒了比心", "疯狂敲碗", "优雅永不过时",
        "破大防了", "小丑竟是我", "尊嘟假嘟", "绝了绝了",
        "退退退", "CPU烧了", "赢麻了", "偷笑不敢看",
        "V我50", "吃瓜一线", "困到起飞", "扛着火车跑"
    ],
    "social": [
        "辛苦老师啦", "收到感谢", "马上安排", "给您倒杯茶",
        "实在抱歉", "感激涕零", "非常理解", "万分感谢",
        "让您见笑了", "请教一下", "祝您顺利", "受宠若惊",
        "拜托您啦", "围观学习", "不打扰您休息", "回聊祝顺"
    ],
    "pet_mood": [
        "开饭啦干饭", "歪头卖萌", "疯狂拆家", "给口吃的吧",
        "狗带了", "猫猫流泪", "哈士奇狂怒", "吓掉猫毛",
        "猫猫鄙视", "狗头问号", "霸气小猫", "舔舔小爪",
        "求摸下巴", "看两脚兽打架", "呼噜呼噜", "撒欢开跑"
    ]
}
...
SCENE_TEXT_TITLES = {
    ...
    "memes": "网络热梗 (魔性搞笑斗图)",
    "social": "礼貌社交 (客气体面沟通)",
    "pet_mood": "萌宠心声 (毛孩子专属内心戏)",
    "custom": "自定义填词 (自由输入16句)"
}
