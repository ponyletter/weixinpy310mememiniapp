...
> ⚠️ **合规勘误（2026-09-22）**：本文关于“审核双轨、公开接口切换、过审后热开启 AI”的方案全部废止。微信运营规范要求提审版本与实际运营版本一致，禁止以技术方式规避审核。当前个人主体版本仅运行本地图片处理；未来 AI 能力须满足资质并作为新版本重新审核。以 `docs/AUDIT_SUBMISSION_GUIDE.md` 为准。
